...
function results() {
  ...
  $("#yint").text("The line of y-intercept is at (0, "+ c +")");
  $("#cp").text("The line of corresponding point is at ("+2*vX+","+ c +")");
  ctx.beginPath();
  ctx.arc(scaledX(0),scaledY(plugX(0)),4,0,6.28);
  ctx.fill();
  ctx.beginPath();
  ctx.arc(scaledX(vX*2),scaledY(plugX(0)),4,0,6.28);
  ctx.fill();
  ctx.beginPath();
  ...
  // quadratic formula and soulutions
  d = b**2-4*a*c
